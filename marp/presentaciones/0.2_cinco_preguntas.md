...
<!--
Esta presentación introduce la herramienta más poderosa del curso: las 5 Preguntas Mágicas. Son un framework sistemático para analizar cualquier problema antes de escribir código.
...
La estructura de la presentación es: introducir las preguntas, mostrar dos ejemplos completos, y enfatizar que esto es inversión de tiempo, no pérdida de tiempo.
-->
...
<!--
Muchos estudiantes quieren saltarse el análisis y pasar directo al código. Es el error más costoso que pueden cometer.

Compartí esta estadística: Los programadores profesionales pasan más tiempo pensando que escribiendo código. La proporción típica es 70% análisis/diseño, 30% codificación.
-->
...
<!--
Estas 5 preguntas son una aplicación directa del método de Pólya para resolver problemas. Las primeras dos preguntas corresponden a "comprender el problema", las preguntas 3 y 5 a "concebir un plan", y luego seguiremos con las etapas de ejecución y verificación.
