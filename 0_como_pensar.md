...
Esta primera etapa es crucial y frecuentemente subestimada. Un problema mal comprendido inevitablemente conduce a una solución incorrecta o incompleta, sin importar cuán elegante sea la implementación.
...
- ¿Cuáles son los datos de entrada (*input*)? ¿Qué tipo de datos son?
...
Esta etapa consiste en la implementación cuidadosa del algoritmo planificado, prestando atención a los detalles sintácticos y semánticos del lenguaje de programación.
...
- **Entrada:** Un string (la contraseña a validar)
- **Salida:** Un booleano (`True` si es válida, `False` si no)
